  ...
  return (
    <div className="flex flex-col h-full px-6 pt-16">
      <div className="flex-1 flex flex-col items-center">
        ...
        <h2 className="text-4xl font-light text-gray-500 text-center">Arriving at</h2>
        ...
        <p className="text-lg text-gray-400 font-medium text-center">Level 2, North Wing</p>

        {/* Visual representation of the spot */}
        <div className="w-full max-w-xs aspect-[4/3] bg-surface rounded-2xl border border-white/10 shadow-2xl relative overflow-hidden my-8 group">
          ...
          <div className="absolute top-4 right-4 flex flex-col items-center gap-1">
            ...
            <span className="text-[10px] uppercase font-bold text-gray-500">Sensor On</span>
          </div>
        </div>

        {/* Walking Path Summary */}
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-bold">{pavilion.name} Pavilion</p>
              </div>
            </div>
            <div className="text-right">
              <p className="text-lg font-bold">3 <span className="text-xs font-normal text-gray-500 uppercase">min</span></p>
              <p className="text-[10px] text-gray-500 font-bold uppercase">150m walk</p>
            </div>
          </div>
          
          <div className="h-24 bg-background rounded-xl overflow-hidden relative border border-white/5">
            <img src="https://picsum.photos/400/200?grayscale" alt="Map Preview" className="w-full h-full object-cover opacity-20" />
            <svg className="absolute inset-0 w-full h-full pointer-events-none">
              <path d="M 40 80 Q 150 70 200 40 T 300 20" fill="none" stroke="#137fec" strokeDasharray="6 4" strokeWidth="3" />
            </svg>
            <div className="absolute bottom-2 left-2 bg-black/60 px-2 py-0.5 rounded text-[8px] font-bold uppercase text-white/80 tracking-widest">Map Preview</div>
          </div>
        </div>
      </div>
      ...
      <div className="pb-12">
        ...
        <p className="text-center text-[10px] text-gray-500 mt-4 uppercase tracking-widest font-bold">Updating sensor status ensures accuracy for other students.</p>
      </div>
    </div>
  );
};
